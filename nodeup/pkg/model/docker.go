...
var dockerVersions = []dockerVersion{
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "17.09.0.ce",
		Source:        "https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-selinux-17.09.0.ce-1.el7.centos.noarch.rpm",
		Dependencies:  []string{"policycoreutils-python"},
	},
}
...
func (b *DockerBuilder) Build(c *fi.ModelBuilderContext) error {
	...
	case distros.DistributionXenial:
		glog.Infof("Hack for NVIDIA AMI. Detected Xenial; won't install Docker")
		/*if err := b.buildContainerOSConfigurationDropIn(c); err != nil {
			return err
		}*/
		return nil
